...
const field =
  'peer w-full rounded-2xl border border-ink/10 bg-white px-5 pt-6 pb-2.5 text-[15px] text-ink outline-none transition focus:border-ink/40 focus:ring-4 focus:ring-gold/25'
const labelCls =
  'pointer-events-none absolute top-2 left-5 text-[10px] font-bold tracking-[0.18em] text-ink/45 uppercase'
        ...
        <div className="mt-14 grid gap-6 lg:mt-20 lg:grid-cols-12 lg:gap-8">
          ...
          <Reveal className="min-w-0 lg:col-span-5">
            <div className="relative h-full overflow-hidden rounded-[28px] bg-ink p-8 text-white sm:p-10">
              ...
              <p className="text-[11px] font-bold tracking-[0.24em] text-gold uppercase">{SITE.name}</p>
                  ...
                  const inner = (
                    <>
                      ...
                      <span className="min-w-0">
                        <span className="block text-[10px] font-bold tracking-[0.2em] text-white/40 uppercase">
                          {label}
                        </span>
              ...
              <Stagger gap={0.06} className="mt-8 grid gap-4 sm:grid-cols-2">
                {(
                  ...
                  <motion.div key={k} variants={fadeUp}>
                    ...
                    {errors[k] && <p className="mt-1.5 pl-2 text-xs text-ember">{errors[k]}</p>}
                  </motion.div>
                ))}
                ...
                <motion.div variants={fadeUp}>
                  <div className="relative">
                    <select
                      ...
                      className={`${field} appearance-none pr-10 ${form.service ? '' : 'text-ink/40'}`}
                    ...
                    <span className="pointer-events-none absolute top-1/2 right-5 -translate-y-1/2 text-ink/40">▾</span>
                  </div>
                  {errors.service && <p className="mt-1.5 pl-2 text-xs text-ember">{errors.service}</p>}
                </motion.div>
                ...
                <motion.div variants={fadeUp} className="relative sm:col-span-2">
                  <textarea
                    ...
                    className={`${field} resize-none pt-7`}
          ...
          <div className="grid overflow-hidden rounded-[28px] bg-white ring-1 ring-ink/[0.06] lg:grid-cols-12">
            ...
            <div className="flex flex-col justify-center p-8 sm:p-10 lg:col-span-4">
              ...
              <div className="mt-6 border-t border-ink/10 pt-6">
                <p className="text-[10px] font-bold tracking-[0.2em] text-ink/40 uppercase">Also at</p>
